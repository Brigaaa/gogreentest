// App.js - GoGreen Final Version (sve u jednom)
...
export default function App() {
  ...
  const [espIp, setEspIp] = useState('192.168.0.105:80'); // ← OVDE PROMIJENI IP ESP32
  ...
  const fetchESPData = async () => {
    try {
      ...
      // fallback na fake podatke ako ESP nije dostupan
      setSensorData({
